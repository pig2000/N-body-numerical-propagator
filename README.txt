...
Users should have the boost C++ library (http://www.boost.org/) and the NAIF-CSPICE (https://naif.jpl.nasa.gov/naif/toolkit_C.html) installed prior to compilation.
